...
IMPLEMENTATION_PATH = \
	crypto_sign/dilithium2/m3ref \
	crypto_sign/dilithium2/m3asmspeed \
	crypto_sign/dilithium2/m3plant \
	crypto_sign/dilithium2/m3old \
	crypto_sign/dilithium3/m3ref \
	crypto_sign/dilithium3/m3asmspeed \
	crypto_sign/dilithium3/m3plant \
	crypto_sign/dilithium3/m3old \
	crypto_sign/dilithium5/m3asmspeed \
...
tests: elf/$(2)_test.elf elf/$(2)_speed.elf elf/$(2)_stack.elf elf/$(2)_testvectors.elf elf/$(2)_hashing.elf
tests-bin: bin/$(2)_test.bin bin/$(2)_speed.bin bin/$(2)_stack.bin bin/$(2)_testvectors.bin bin/$(2)_hashing.bin
tests-hex: bin/$(2)_test.hex bin/$(2)_speed.hex bin/$(2)_stack.hex bin/$(2)_testvectors.hex bin/$(2)_hashing.hex
