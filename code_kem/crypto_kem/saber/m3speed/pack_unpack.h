...
extern void __asm_16_to_3(uint8_t*, const uint16_t*);
extern void __asm_16_to_4(uint8_t*, const uint16_t*);
extern void __asm_16_to_6(uint8_t*, const uint16_t*);
extern void __asm_16_to_10(uint8_t*, const uint16_t*);
extern void __asm_16_to_13(uint8_t*, const uint16_t*);
...
static inline void POLp2BS(uint8_t bytes[SABER_POLYCOMPRESSEDBYTES], const uint16_t data[SABER_N]);
static inline void POLq2BS(uint8_t bytes[SABER_POLYBYTES], const uint16_t data[SABER_N]);
static inline void POLT2BS(uint8_t bytes[SABER_SCALEBYTES_KEM], const uint16_t data[SABER_N]);
